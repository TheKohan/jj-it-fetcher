...
export namespace Prisma {
  ...
  */
  ...
  export type B2BOfferAggregateArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = {
    /**
     ...
     */
    orderBy?:
      | B2BOfferOrderByWithRelationInput
      | B2BOfferOrderByWithRelationInput[];
    /**
  ...
  export type B2BOfferGroupByArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = {
    where?: B2BOfferWhereInput;
    orderBy?:
      | B2BOfferOrderByWithAggregationInput
      | B2BOfferOrderByWithAggregationInput[];
  ...
  type GetB2BOfferGroupByPayload<T extends B2BOfferGroupByArgs> =
  ...
  type B2BOfferGetPayload<
    S extends boolean | null | undefined | B2BOfferDefaultArgs
  > = $Result.GetResult<Prisma.$B2BOfferPayload, S>;

  type B2BOfferCountArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = Omit<B2BOfferFindManyArgs, 'select' | 'include' | 'distinct'> & {
    select?: B2BOfferCountAggregateInputType | true;
  };

  export interface B2BOfferDelegate<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > {
    [K: symbol]: {
      types: Prisma.TypeMap<ExtArgs>['model']['B2BOffer'];
      meta: { name: 'B2BOffer' };
    };
    /**
    ...
    ): Prisma__B2BOfferClient<
      $Result.GetResult<
        Prisma.$B2BOfferPayload<ExtArgs>,
        T,
        'findUnique'
      > | null,
      null,
    ...
    findMany<T extends B2BOfferFindManyArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$B2BOfferPayload<ExtArgs>, T, 'findMany'>
    >;
    ...
    create<T extends B2BOfferCreateArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$B2BOfferPayload<ExtArgs>, T, 'create'>,
      never,
      ExtArgs
    >;
    ...
    delete<T extends B2BOfferDeleteArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$B2BOfferPayload<ExtArgs>, T, 'delete'>,
      never,
      ExtArgs
    >;
    ...
    update<T extends B2BOfferUpdateArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$B2BOfferPayload<ExtArgs>, T, 'update'>,
      never,
      ExtArgs
    >;
    ...
    upsert<T extends B2BOfferUpsertArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$B2BOfferPayload<ExtArgs>, T, 'upsert'>,
      never,
      ExtArgs
    >;
     ...
     * })
     **/
    aggregate<T extends B2BOfferAggregateArgs>(
      args: Subset<T, B2BOfferAggregateArgs>
    ): Prisma.PrismaPromise<GetB2BOfferAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, B2BOfferGroupByArgs, OrderByArg> & InputErrors
    ): {} extends InputErrors
      ? GetB2BOfferGroupByPayload<T>
   ...
   */
  export interface Prisma__B2BOfferClient<
    T,
    Null = never,
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
   ...
   * B2BOffer findUnique
   */
  export type B2BOfferFindUniqueArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = {
    /**
   ...
   */
  export type B2BOfferFindUniqueOrThrowArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = {
    /**
     * Select specific fields to fetch from the B2BOffer
   ...
   * B2BOffer findFirst
   */
  export type B2BOfferFindFirstArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = {
    /**
     * Select specific fields to fetch from the B2BOffer
   ...
   */
  export type B2BOfferFindFirstOrThrowArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = {
    /**
     * Select specific fields to fetch from the B2BOffer
   ...
   * B2BOffer findMany
   */
  export type B2BOfferFindManyArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = {
    /**
     * Select specific fields to fetch from the B2BOffer
   ...
   * B2BOffer create
   */
  export type B2BOfferCreateArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = {
    /**
     * Select specific fields to fetch from the B2BOffer
   ...
   * B2BOffer createMany
   */
  export type B2BOfferCreateManyArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = {
    /**
   ...
   * B2BOffer update
   */
  export type B2BOfferUpdateArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = {
    /**
     * Select specific fields to fetch from the B2BOffer
   ...
   * B2BOffer updateMany
   */
  export type B2BOfferUpdateManyArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = {
    /**
     ...
     */
    data: XOR<
      B2BOfferUpdateManyMutationInput,
      B2BOfferUncheckedUpdateManyInput
    >;
    /**
   ...
   * B2BOffer upsert
   */
  export type B2BOfferUpsertArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = {
    /**
     * Select specific fields to fetch from the B2BOffer
   ...
   * B2BOffer delete
   */
  export type B2BOfferDeleteArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = {
    /**
     * Select specific fields to fetch from the B2BOffer
   ...
   * B2BOffer deleteMany
   */
  export type B2BOfferDeleteManyArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = {
    /**
   ...
   */
  export type B2BOfferDefaultArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = {
    /**
     * Select specific fields to fetch from the B2BOffer
  ...
  export type B2BOfferScalarFieldEnum =
    (typeof B2BOfferScalarFieldEnum)[keyof typeof B2BOfferScalarFieldEnum];
  ...
  export type B2BOfferScalarWhereWithAggregatesInput = {
    AND?:
      | B2BOfferScalarWhereWithAggregatesInput
      | B2BOfferScalarWhereWithAggregatesInput[];
   ...
   */
  export type B2BOfferArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = B2BOfferDefaultArgs<ExtArgs>;
