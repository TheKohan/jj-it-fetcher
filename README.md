...
Job board scraper with integrated discord notifications to keep you posted daily. Features a minimalistic ui with offers preview. You can check the live version [here](https://jj-it-fetcher.pkochanowski.pl/app).
